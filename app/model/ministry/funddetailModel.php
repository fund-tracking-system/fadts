...
if(isset($_GET['fundId'])||isset($_GET['regionId']))
        ...
        $sql4="SELECT fundregion.regionId,region.level from fundregion inner join region ON  region.regionId=fundregion.regionID where fundId=$fundId";        
        $result4=$con->query($sql4);
        $res4=$result4->fetch_all(MYSQLI_ASSOC);
        $_SESSION['regionList']=$res4;
        foreach($res4 as $fr){
