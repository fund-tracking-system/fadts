<?php 
    ...
    //prepare and bind
    $query =   'SELECT user.userid, user.username, user.usernid, user.email, user.userrole, user.region, region.name, region.level, user.loginStatus 
                FROM user 
    ...
    //redirecting to view
    header("Location:/fadts/ministry/viewOfficerView"); 
    exit(); 
?>