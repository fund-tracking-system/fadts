                        ...
                        <div class="form-row " style="display: flex;">
                            <div style="display: flex;">
                                ...
                                <input class="form-control " id='NID-number'
                                    ...
                                    placeholder="SPGAEL5050M" required></input>
                                <small></small>
        ...
        <form>
            <fieldset
                ...
                <div class="form-row" style="margin-top:30px;">
                    <label for="phone-number" style="margin-left:50px;margin-bottom:18px;"><b>Phone
                            Number:</b></label>
                ...
                <div class='buttons' style="margin-left:875px;margin-bottom:20px;">
