                  ...
                  <div class="form-row " style="display: flex;">
                     <div style="display: flex;">
                        <label for="Defined-Fund"
                           style="margin-left:230px;margin-bottom:5px; margin-top:5px; padding-right:70px;"><b>NID:</b></label>
                        ...
                        <div class='button '>
                           ...
                           <button type="submit" class='submit-button btn btn-primary btn btn-primary'
                              style="margin-left:80px;margin-top:-5px; padding-bottom:10px; padding-right:40px;padding-left:40px;"
      ...
      <fieldset style="background-color:#fffef4; border-bottom:10px; padding-bottom:12px;padding-top:20px; ">
         <form>
            ...
            <div class='form-row ' style="margin-top:50px;">
               <div style="display: flex;">
                  <label class='income-label' style="margin-left:70px;margin-bottom:18px;margin-top:10px;"><b>Gross
                        Income:</b></label>
                  <input class='first form-control'
            ...
            <div class="multiselect">
               ...
               <div id="checkboxes" style="margin-left:20.5%; margin-top:-1.5%; background-color:white; border:none ">
                  <label for="one">
