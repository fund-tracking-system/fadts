...
<div class="all_bacground_clor">
    ...
    <li>Then the User has to assign region for the Officer. The User can enter the Region or filter region according to the levels<br> like 
    ...
    <h3>CREATE FUND</h3>
    <ul>
    <li>When the User clicks on Create fund and enter into the page, The user can add new fund by entering Fund name,<br> Amount per person,
    and Region.</li><br>
