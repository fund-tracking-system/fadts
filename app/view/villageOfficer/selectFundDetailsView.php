                     ...
                     <thead>
                        ...
                        <th>
                           <div class="box3">
                              ...
                              <input class="form-control details" type="hidden" style="margin-left:100px;"
                        ...
                        <th>
                           <div class="box3">
                              ...
                              <input class="form-control details" type="hidden" style="margin-left:100px;"
                                 id='dilivered' value="<?php echo $_SESSION['fundDelivered']?>" readonly></input>
                           </div>
                        </th>
                        ...
                        <th>
                           <div class="box3">
                              ...
                              <h3>ministry</h3>
                              <input class="form-control details" type="hidden" style="margin-left:100px;"
                                 id='undelivered' value="<?php echo $_SESSION['fundUndelivered']?>" readonly></input>
                           </div>
                        </th>
                        ...
                        <th>
                           <div class="box3">
                              ...
                              <input class="form-control details" id='' type="hidden" style="margin-left:100px;"
