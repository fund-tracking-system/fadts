            ...
            <fieldset class="BackgroundFS">
                ...
                <fieldset class="searchBar">
                    <div class="form-row ">
                        ...
                        <input style="margin-left:90px; width:450px;" class="form-control searchInput" id="NID-number"  name="NID"></input>
        ...
        <form method="post" id="form">
            <fieldset class="BackgroundFS">
                ...
                <fieldset class="searchBar" style=" padding:0%;padding-top:3%;">
                    ...
                    <div class='form-row'>
                        <label class="inputLable"style="margin-right:9.5%;"><><b>Current Funds :</br></label>
                        <select class="js-example-responsive" multiple="multiple"
