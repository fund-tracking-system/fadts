    ...
    <div class='SearchByCriteriaform1'>
        <form class="form" method="post" action="" id="form">
            <fieldset style="background-color:#fffef4;">
                ...
                <button style="margin-left: 75%;  margin-bottom:50px;width:13%;" type="submit"
                    class="btn btn-primary">Select</button>
            </fieldset>
        </form>
        <form method="post" action="" id="form">
            <fieldset style="background-color:#fffef4; margin-top:5px;">
                ...
                <div class="form-row">
                    <div style="display:flex;">
                        <label class='phone-number-label' for="number"
                            style="margin-left:70px;margin-bottom:18px;"><b>Fund
                                Amount:</b></label>
