...
function checkInputsReset(){
 ...
 {
   setErrorFor(newpassword, " New password should contain at least 6 characters");
 }
 else
 {
   e=1;
 ...
 else if (reEnterValue.length < 6) 
 {
   setErrorFor(reEnter, "Re entered password should contain at least 6 characters");
 }
 else
 {
   f=1;
