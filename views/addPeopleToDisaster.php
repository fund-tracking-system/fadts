...
<div style="background-color:#ced4da">
    <div class="SearchByCriteriaform1">
        ...
        <form id="formAddVictims">

            <fieldset
            style="background-color:#fffef4;margin-left:20px  border-bottom:10px; padding-bottom:12px;padding-top:20px; margin-top:-0.5%; ">
                <h2 style="color:black ; margin-bottom:88px;padding-top:10px;text-align: center;"> Add Victims to Disaster
                </h2>
                ...
                <div class="form-row" style="margin-top:30px;">
                    <label for="nid" style="margin-left:70px;margin-bottom:30px; ">NID Number:</label>
                    <input class="form-control" id='nid' name="nid" placeholder="982000410V"
                        style="margin-left:250px;margin-bottom:30px;margin-right:150px; margin-top:-4.5%"
                        aria-describedby="validationServer03Feedback" ></input>
                </div>
                <div class="form-row" style="margin-top:30px;">
