...
<div class="all_bacground_clor">
    <div>
        ...
        <form method="post" action="" id="formAddEligibilityList">
                ...
                <fieldset style="background-color:#fffef4; border-bottom:10px; padding-bottom:12px;">
                    ...
                    <fieldset style="padding-top:15px; margin-right:50px; margin-left:20px;border-radius:10px; ">
                        <div class="form-row" style="margin-top:5%;">
                            <label for="select_region" style="margin-left:200px;margin-bottom:18px;">Select Predefined
                                Fund:</label>
                            <select name="select_region" id="select_region" name="select_region" 
