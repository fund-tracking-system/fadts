...
<div class="all_bacground_clor">>
    ...
    <form method="post" action="" style="margin-top:-30%;" id="formDisasterDetails">
        <div class="SearchByCriteriaform1 ">
            ...
            style="background-color:#fffef4; border-bottom:10px; padding-bottom:12px;">
                ...
                <div class="form-row">
                    <label for="select_disaster" style="margin-left:230px;margin-bottom:18px;">Select Disaster:</label>
                    <select name="select_disaster" id="select_disaster"
